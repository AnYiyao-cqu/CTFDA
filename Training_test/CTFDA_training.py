...
class DASMNLearner:
    ...
    def joint_training_2op(self, src_tasks, tgt_tasks, model_path):
        ...
        optimizer1 = torch.optim.SGD(self.model.parameters(), lr=0.1, momentum=0.9)
...
if __name__ == "__main__":
    ...
    if flag == 'y' or flag == 'Y':
        ...
        save_path = os.path.join(m_f_root, 'CTFDA_funnySAnCLtest_cqutootw_' + str(running_params['train_split']))
    ...
    flag = input('Test? y/n\n')
    if flag == 'y' or flag == 'Y':
        load_path = r"E:\CTFDA\Modelsave\CTFDA\CTFDA_funnySAnCLtest_cqutootw_100\final_epoch10"
