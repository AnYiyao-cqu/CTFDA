...
def get_omega_s(domain_out, before_softmax, domain_temperature=1.0, class_temperature=10.0):
...
def get_omega_t(domain_out, before_softmax, domain_temperature=1.0, class_temperature=10.0):
    return - get_omega_s(domain_out, before_softmax, domain_temperature, class_temperature)
